...
public class JpaRealmProvider implements RealmProvider, ClientProvider, ClientScopeProvider, GroupProvider, RoleProvider, DeploymentStateProvider {
    ...
    public boolean removeRole(RoleModel role) {
        ...
        em.createNamedQuery("getParentRolesOfACompositeRole", RoleEntity.class).setParameter("compositeRole", roleEntity).getResultStream()
                .forEach(parentRole -> parentRole.getCompositeRoles().remove(roleEntity));
